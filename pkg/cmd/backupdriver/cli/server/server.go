...
func newServer(f client.Factory, config serverConfig, logger *logrus.Logger) (*server, error) {
	...
	backupdriverInformerFactory := pluginInformers.NewSharedInformerFactoryWithOptions(backupdriverClient, config.resyncPeriod, pluginInformers.WithNamespace(f.Namespace()))
